sudo rm BITFINEX-BCHUSD.csv BITFINEX-BTCUSD.csv BITFINEX-ETHUSD.csv BITFINEX-ETCUSD.csv BITFINEX-LTCUSD.csv BITFINEX-XMRUSD.csv BITFINEX-ZECUSD.csv
curl https://www.quandl.com/api/v3/datasets/BITFINEX/BCHUSD.csv?api_key=25hmrVodDAz9wn53zGbv > BITFINEX-BCHUSD.csv
curl https://www.quandl.com/api/v3/datasets/BITFINEX/BTCUSD.csv?api_key=25hmrVodDAz9wn53zGbv > BITFINEX-BTCUSD.csv
curl https://www.quandl.com/api/v3/datasets/BITFINEX/ETHUSD.csv?api_key=25hmrVodDAz9wn53zGbv > BITFINEX-ETHUSD.csv
curl https://www.quandl.com/api/v3/datasets/BITFINEX/ETCUSD.csv?api_key=25hmrVodDAz9wn53zGbv > BITFINEX-ETCUSD.csv
